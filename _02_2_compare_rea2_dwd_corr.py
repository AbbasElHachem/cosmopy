...
#                             print(msg)
    ...
    #                 df_dwd1.max()
                    try:
                        spr_corr = spr(cmn_vals1, cmn_rea1)[0]
                        prs_corr = prs(cmn_vals1, cmn_rea1)[0]
                        sep_dist = distance_sorted[ix2]

                        spr_corr_rea = spr(cmn_vals2, cmn_rea2)[0]
                        prs_corr_rea = prs(cmn_vals2, cmn_rea2)[0]
...
#         break
    ...
    if test_for_extremes:
        ...
        plt.savefig(os.path.join(
            path_to_all_rea2_files,
            #             '/analysis',
            r'prs_corr_all_%d_rea_dwd.png' % (_year)))
    plt.close()
    ...
    if not test_for_extremes:
        ...
        plt.savefig(os.path.join(
            path_to_all_rea2_files,
            #             r'analysis',
            r'spr_corr_all_%d_rea_dwd.png' % (_year)))
        plt.close()
