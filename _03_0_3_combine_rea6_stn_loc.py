...
#path_to_all_rea6_files = r'/run/media/abbas/EL Hachem 2019/REA6/Extracted_Hannover_Daily'
path_to_all_rea2_files = r"/run/media/abbas/EL Hachem 2019/REA_Pcp/"

out_save_dir = (
    r'/run/media/abbas/EL Hachem 2019/REA6/Extracted_Hannover_Daily/comb_years')
out_save_dir = (
    os.path.join(path_to_all_rea2_files, 'comb_years'))
...
start_year = '01-01-2007 00:00:00'  # 01
end_year = '31-12-2013 23:00:00'
date_range = pd.date_range(start_year, end_year, freq='H') 
print(date_range)
...
df_comb_Stn.to_csv(os.path.join(out_save_dir, 'rea2_2007_2013.csv'), sep=';')
print('done')
