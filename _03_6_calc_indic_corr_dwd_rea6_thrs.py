...
percentile_levels = [0.95, 0.98, 0.99, 0.992, 0.995, 0.999]
    ...
    #         break
        ...
        if calc_cross_corr:
            ...
            plt.savefig(os.path.join(
                out_save_dir,
                #             r'analysis',
                r'cross_corr_all_%d_rea_dwd_%s.png' % (temp_agg)))
            ...
            plt.savefig(os.path.join(
                out_save_dir,
                #             r'analysis',
                r'scatter_cross_corr_%d_rea_dwd_%s2_qq.png' % (temp_agg)))
            plt.close()
        #======================================================================
        # pearson corr
        #======================================================================
        ...
        if test_for_extremes:
            plt.savefig(os.path.join(
                out_save_dir,
                #             r'analysis',
                r'indic_corr_all_%d_rea_dwd_%s.png' % (temp_agg)))
        else:
            plt.savefig(os.path.join(
                out_save_dir,
                #             '/analysis',
                r'prs_corr_all_%d_rea_dwd_%s_qq.png' % (temp_agg)))
        plt.close()
        ...
        if not test_for_extremes:
            ...
            plt.savefig(os.path.join(
                out_save_dir,
                #             r'analysis',
                r'spr_corr_all_%d_rea_dwd_%s.png' % (temp_agg)))
            plt.close()
